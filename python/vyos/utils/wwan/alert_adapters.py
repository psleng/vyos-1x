...
# igosWwanNotifications.0 ({ igos 1 }.2.0.N == .1.3.6.1.4.1.1966.30.1.2.0.N).
...
ALERT_CODE_TO_SNMP_OID = {
    ...
    'WWAN_FSM_FAILED':            '1.3.6.1.4.1.1966.30.1.2.0.1',
    'WWAN_RECONNECT_ATTEMPT':     '1.3.6.1.4.1.1966.30.1.2.0.1',
    # igosWwanFailoverEvent       (.2)
    'WWAN_SIM_FAILOVER':          '1.3.6.1.4.1.1966.30.1.2.0.2',
    'WWAN_SIM_SWITCH':            '1.3.6.1.4.1.1966.30.1.2.0.2',
    # igosWwanBearerUp/Down       (.4 / .5)
    'WWAN_BEARER_UP':             '1.3.6.1.4.1.1966.30.1.2.0.4',
    'WWAN_BEARER_DOWN':           '1.3.6.1.4.1.1966.30.1.2.0.5',
    # igosWwanDataLimitWarning/Reached (.7 / .8)
    'WWAN_USAGE_WARNING':         '1.3.6.1.4.1.1966.30.1.2.0.7',
    'WWAN_USAGE_LIMIT_EXCEEDED':  '1.3.6.1.4.1.1966.30.1.2.0.8',
}
...
class SnmpAlertAdapter(AlertAdapterBase):
    ...
    def __init__(
        ...
        *,
        default_oid: str = '1.3.6.1.4.1.1966.30.1.2.0.255',
    ) -> None:
