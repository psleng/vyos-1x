...
echo ""
echo "2. Or start the systemd service manually for testing"
echo "   (it is normally auto-started when you commit an"
echo "   'interfaces wwan' config; the unit has no [Install]"
echo "   section, so do NOT 'systemctl enable' it):"
